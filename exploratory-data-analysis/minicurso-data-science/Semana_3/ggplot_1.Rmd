...
```
ggplot foi desenvolvido por Hadley Wickham a partir de sua tese de doutorado "The Grammar of Graphics". Construíremos gráficos a partir de cada um dos seus componentes. A gramática vem das múltiplas camadas de um gráfico. 

Para começar, vamos instalar e carregar o pacote ggplot2
